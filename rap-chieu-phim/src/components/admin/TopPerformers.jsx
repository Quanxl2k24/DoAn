...
const scrollbarStyles = `
  ...
  .thin-scroll::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.15); border-radius: 4px; }
  .thin-scroll::-webkit-scrollbar-thumb:hover { background: rgba(255,255,255,0.25); }
`;
  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <div className="space-y-6 max-h-[360px] overflow-y-auto pr-2 thin-scroll">
