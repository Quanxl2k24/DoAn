...
const AdminHeader = ({ title, subtitle, children }) => {
  return (
    <header className="flex justify-between items-end mb-16">
      ...
      {children || (
        <button className="bg-primary-container text-on-primary-container px-6 py-3 rounded-md font-bold text-sm flex items-center gap-2 hover:scale-105 transition-transform">
