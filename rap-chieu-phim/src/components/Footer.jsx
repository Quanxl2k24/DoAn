    ...
    <footer className="hidden md:block py-20 px-16 border-t border-white/5 bg-surface-container-low">
      ...
      <div className="max-w-[1920px] mx-auto grid grid-cols-3 gap-12">
        ...
        <div className="col-span-1">
          <h1 className="text-2xl font-black italic text-[#E50914] tracking-tighter font-headline mb-6">
            NOIR CINEMA
          </h1>
          <p className="text-secondary text-sm leading-relaxed mb-6">
            Hệ thống rạp chiếu phim tiêu chuẩn quốc tế, mang đến trải nghiệm
            điện ảnh chân thực và đẳng cấp nhất.
          </p>
        ...
        {/* Cột 2: Dịch vụ */}
        <div>
          <h5 className="font-bold mb-6 tracking-widest text-xs uppercase text-primary">
            DỊCH VỤ
          </h5>
